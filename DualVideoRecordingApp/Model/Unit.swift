...
//
//  Created by Sharan Thakur on 17/02/25.
//

import Foundation

enum Unit: String, CaseIterable, CustomStringConvertible {
    ...
    static var selected: Self {
        ...
        guard let unitIdentifier = UserDefaults.standard.string(forKey: Constants.selectedUnit.rawValue) else {
            return .default
        }
    ...
    var next: Self {
        ...
        UserDefaults.standard.set(unit.rawValue, forKey: Constants.selectedUnit.rawValue)
